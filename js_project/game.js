...
function draw1() {
  ...
  document.getElementById("instructions").innerHTML = "*click on the square to place your mark*<br>get 3 in a row to win!";
...
function gameOver() {
  ...
  document.getElementById("play_again").innerHTML += "<button type='button' style='font-size: 15px;'>play again?</button>";
